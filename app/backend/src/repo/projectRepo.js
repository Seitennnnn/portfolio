...
exports.getAllProjects = async (page, limit) => {
 ...
 const result = await db.query("SELECT * FROM projects LIMIT $1 OFFSET $2", [limit, offset])
 return result.rows
}
...
exports.createProject = async (title,description,technologies,image) => {
 const result = await db.query(
  "INSERT INTO projects (title,description,technolog,image) VALUES ($1,$2,$3,$4) RETURNING *",
